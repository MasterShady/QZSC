...
//    return resultString;
    ...
    NSString *resultString = [encryptData base64EncodedStringWithOptions:0]; // 以base64的加密结果输出
    return resultString;
...
//    return @((char *)decipher);
    ...
    // 解密
    NSData *raw = [[NSData alloc] initWithBase64EncodedString:data options:0];
//    NSData *raw = [data dataUsingEncoding:NSUTF8StringEncoding];
    
    NSData *dencryptData = [[EPRc4CryptorManager shareInstance] dencryptData:raw];
