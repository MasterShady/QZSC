...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/DFGameAutoLoginLib/DFGameAutoLoginLib/Frameworks/HMCloudPlayerCore.framework"
  install_framework "${PODS_ROOT}/DFGameAutoLoginLib/DFGameAutoLoginLib/Frameworks/HMWebRTC.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DFOCBaseLib/DFOCBaseLib.framework"
