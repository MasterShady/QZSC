...
@interface DDDAlertHKMideViewFFF ()<UIWebViewDelegate, WKNavigationDelegate, WKUIDelegate>
...
@implementation DDDAlertHKMideViewFFF
...
- (WKWebView *)webView {
    if (!_webView) {
        ...
        DDDSuspendURLSchemeHandlerFFF *handler = [DDDSuspendURLSchemeHandlerFFF new];
